...
export default function SideBar() {
  ...
  return (
    <>
      {/* up 1024px width */}
      <aside className="hidden lg:block w-64 px-3 bg-dark border-solid border-r border-r-dark-500 overflow-auto scrollbar-none">
        ...
        <div className=" flex flex-col gap-y-3 ">
          {sideBarLink?.map((item, index) => (
            <>
              <Link
                href={item.srcLink}
                className="flex items-center justify-between  py-3 px-5 hover:bg-cloud-900 rounded-lg"
                key={index}
